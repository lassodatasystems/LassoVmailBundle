 ...
 */
    public function mailboxCreationFailsWhenEmailExists(){
        ...
        $mailboxManager = new MailboxManager($mockEm, $mockAliasRepo, $mockDomainRepo, $mockEmailRepo, $mockMailboxRepo, $mockLogger, 2147483648);
    ...
    public function createMailboxWithNoHashOption(){
        ...
        $mailboxManager = new MailboxManager($mockEm, $mockAliasRepo, $mockDomainRepo, $mockEmailRepo, $mockMailboxRepo, $mockLogger, 2147483648);
        $return = $mailboxManager->createMailbox($username, 'password', $domain, 0, true);
